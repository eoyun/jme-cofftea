...
def get_jme_correctors():
    ext = extractor()
    ext.add_weight_sets([
        f"* * {jmecofftea_path('data/jme/Winter22Run3_RunC_V2_DATA_L1FastJet_AK4PFPuppi.txt')}",
        f"* * {jmecofftea_path('data/jme/Winter22Run3_RunC_V2_DATA_L2Relative_AK4PFPuppi.txt')}",
        f"* * {jmecofftea_path('data/jme/Winter22Run3_RunC_V2_DATA_L2Residual_AK4PFPuppi.txt')}",
        f"* * {jmecofftea_path('data/jme/Winter22Run3_RunC_V2_DATA_L3Absolute_AK4PFPuppi.txt')}",
        f"* * {jmecofftea_path('data/jme/Winter22Run3_RunC_V2_DATA_L2L3Residual_AK4PFPuppi.txt')}",
    ])
    ext.finalize()
